...
<body>
    ...
    <form method="POST" action="./commande_login.php">
        <h3>Pour accéder à votre panier veuillez-vous connecter</h3>

        <label class="ahah" for="pseudo">Pseudo</label>
        <input type="text" name="pseudo" placeholder="Entrez votre pseudo..." id="pseudo" required autocomplete="on">

        <label class="ahah" for="mdp">Mot de Passe</label>
